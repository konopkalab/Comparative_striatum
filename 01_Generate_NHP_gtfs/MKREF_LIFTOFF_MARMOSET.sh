...
mkdir caljac3_human_liftoff
cd caljac3_human_liftoff

# Create cellranger reference
cellranger mkref --genome=reference_genome --fasta=~/workdir/REFERENCES/FASTA_ONLY/calJac3.fa --genes=~/workdir/REFERENCES/GTF_ONLY/hg38_liftoverTo_calJac3.gtf
