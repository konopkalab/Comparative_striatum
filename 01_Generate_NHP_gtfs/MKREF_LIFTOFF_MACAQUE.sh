...
mkdir rheMac10_human_liftoff
cd rheMac10_human_liftoff

# Create cellranger reference
cellranger mkref --genome=reference_genome --fasta=~/workdir/REFERENCES/FASTA_ONLY/rheMac10.fa --genes=~/workdir/REFERENCES/GTF_ONLY/hg38_liftoverTo_rheMac10.gtf
