...
cd /home2/gkonop/project/CELLRANGER_OUT/MACAQUE_HE2021

refdir="/home2/gkonop/workdir/REFERENCES/cellranger_reference_RNA/rheMac10_human_liftoff/reference_genome"
fastqdir="/home2/gkonop/project/FASTQ/MACAQUE_HE2021"

# Run cellranger
cellranger count --id=celllranger_count_SRR13808466 --transcriptome=$refdir --fastqs=$fastqdir --sample=SRR13808466 --include-introns
