...
#SBATCH -o count_h_%j.out
#SBATCH -e count_h_%j.err
...
# Run all caudates
cellranger count --id=Sample_242970 --transcriptome=$refdir --fastqs=$fastqdir --sample=Sample_242970
