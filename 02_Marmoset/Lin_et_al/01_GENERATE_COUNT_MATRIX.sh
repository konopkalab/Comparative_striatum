...
cd /home2/gkonop/project/01_CELLRANGER_OUT/MARMOSET_LIN

refdir="/home2/gkonop/workdir/REFERENCES/cellranger_reference_RNA/caljac3_human_liftoff/reference_genome"
fastqdir="/home2/gkonop/project/00_FASTQ/MARMOSET_LIN"

# Run cellranger
cellranger count --id=celllranger_count_v321 --transcriptome=$refdir --fastqs=$fastqdir --sample=v321 --include-introns

# Run cellranger
cellranger count --id=celllranger_count_v324 --transcriptome=$refdir --fastqs=$fastqdir --sample=v324 --include-introns
