...
# Subset non-spns
seurM = read_rds('~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/Chimp_CaudatePutamen_NEURONS_Annotated.RDS')
...
pref = 'Chimp_CaudatePutamen_NONSPN'
...
# Move the plots
dir.create('~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/CAUDATE_PUTAMEN_NONSPN/CLUSTERING_1/')
outfls = list.files('~/', pattern = pref, full.names = F)
todir = '~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/CAUDATE_PUTAMEN_NONSPN/CLUSTERING_1/'
dir.create(todir)
sapply(outfls, function(x){file.copy(from = paste0('~/', x), to = paste0(todir, x))})
file.remove(outfls)

# Save (optional)
write_rds(seurM_corr, '~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/Chimp_CaudatePutamen_NONSPN_Clustering1.RDS')
seurM_corr = read_rds('~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/Chimp_CaudatePutamen_NONSPN_Clustering1.RDS')
...
# Move the plots
outfls = list.files('~/', pattern = pref, full.names = F)
todir = '~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/CAUDATE_PUTAMEN_NONSPN/CLUSTERING_2/'
dir.create(todir)
sapply(outfls, function(x){file.copy(from = paste0('~/', x), to = paste0(todir, x))})
file.remove(outfls)

# Save (optional)
write_rds(seurM_corr, '~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/Chimp_CaudatePutamen_NONSPN_Clustering2.RDS')
seurM_corr = read_rds('~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/Chimp_CaudatePutamen_NONSPN_Clustering2.RDS')
...
# Move the plots
outfls = list.files('~/', pattern = pref, full.names = F)
todir = '~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/CAUDATE_PUTAMEN_NONSPN/CLUSTERING_3/'
dir.create(todir)
sapply(outfls, function(x){file.copy(from = paste0('~/', x), to = paste0(todir, x))})
file.remove(outfls)

# Save (optional)
write_rds(seurM_corr, '~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/Chimp_CaudatePutamen_NONSPN_Clustering3.RDS')
seurM_corr = read_rds('~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/Chimp_CaudatePutamen_NONSPN_Clustering2.RDS')
...
mapnames = setNames(c('PVALB_PTHLH', 'TAC3', 'SST_NPY', 'CHAT', 'FOXP2_EYA2', 'TAC3',
			'PVALB_PTHLH', 'CCK_VIP+', 'UNK_1', 'UNK_2'),
		      c(0:9))
...
# Move the plots
outfls = list.files('~/', pattern = pref, full.names = F)
todir = '~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/CAUDATE_PUTAMEN_NONSPN/ANNOTATED/'
dir.create(todir)
sapply(outfls, function(x){file.copy(from = paste0('~/', x), to = paste0(todir, x))})
file.remove(outfls)

# Save (optional)
write_rds(seurM_corr, '~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/Chimp_CaudatePutamen_NONSPN_Annotated.RDS')
seurM_corr = read_rds('~/workdir/01_CHIMP/03_CLUSTER_ANNOTATE/Chimp_CaudatePutamen_NONSPN_Annotated.RDS')
